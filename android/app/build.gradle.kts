...
android {
    ...
    defaultConfig {
        ...
        // minSdk 26 (Android 8): reliable SAF + camera plugin (PLAN.md §11).
        minSdk = 26
        targetSdk = 35
    ...
    buildTypes {
        release {
            // Shrink code + resources for a small APK (PLAN.md §7a).
            ...
            // TODO(release): replace with a real signing config before shipping.
